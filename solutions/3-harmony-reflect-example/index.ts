...
export function createMembrane(initWetTarget) {
  ...
  dryToWetRef.val = dryToWetMaker(dryToWetCache, wetToDryCache, dryToWetRef, wetToDryRef);

  // note the reversed order of wetToDry and dryToWet:

  wetToDryRef.val = dryToWetMaker(wetToDryCache, dryToWetCache, wetToDryRef, dryToWetRef);
