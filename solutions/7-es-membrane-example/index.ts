...
var Membrane = (function () {
  ...
  */
  ...
  function WeakMapOfProxyMappings(map) {
    Reflect.defineProperty(map, "delete", new NWNCDataDescriptor(WeakMapOfProxyMappings.delete));
    Reflect.defineProperty(map, "set", new NWNCDataDescriptor(WeakMapOfProxyMappings.set.bind(map, map.set)));
    Reflect.defineProperty(map, "revoke", new NWNCDataDescriptor(WeakMapOfProxyMappings.revoke));
  }
  ...
  WeakMapOfProxyMappings.set = function (_set, key, value) {
    if (value !== WeakMapOfProxyMappings.Dead) {
      ...
      if (current === WeakMapOfProxyMappings.Dead) throw new Error("WeakMapOfProxyMappings says this key is dead");
  ...
  function AssertIsPropertyKey(propName) {
    ...
    if (type != "string" && type != "symbol") throw new Error("propName is not a symbol or a string!");
    return true;
  }
  ...
  }
  {
    ...
    Object.defineProperties(ProxyMapping.prototype, {
      ...
      set: new DataDescriptor(function (membrane, field, parts) {
        ...
        if (!override && this.hasField(field)) throw new Error("set called for previously defined field!");

        this.proxiedFields[field] = parts;

        if (override || field !== this.originField) {
          if (valueType(parts.proxy) !== "primitive") {
            if (DogfoodMembrane && membrane !== DogfoodMembrane) DogfoodMembrane.ProxyToMembraneMap.add(parts.proxy);
        ...
        if (!membrane.map.has(parts.value)) {
          if (DogfoodMembrane && membrane !== DogfoodMembrane) DogfoodMembrane.ProxyToMembraneMap.add(parts.value);
      ...
      remove: new DataDescriptor(function (field) {
         ...
         * original object.
         */
        Reflect.defineProperty(this.proxiedFields, field, new NWNCDataDescriptor(WeakMapOfProxyMappings.Dead));
      }),
      ...
      revoke: new DataDescriptor(function (membrane) {
        ...
        for (let i = 1; i < fields.length; i++) {
          ...
          if (typeof parts.revoke === "function") parts.revoke();
          if (Object(parts.value) === parts.value) membrane.revokeMapping(parts.value);
          if (Object(parts.proxy) === parts.proxy) membrane.revokeMapping(parts.proxy);
          if (Object(parts.shadowTarget) === parts.shadowTarget) membrane.revokeMapping(parts.shadowTarget);
        }
      ...
      deleteLocalDescriptor: new DataDescriptor(function (fieldName, propName, recordLocalDelete) {
        let metadata = this.proxiedFields[fieldName];
  ...
  function MembraneInternal(options = {}) {
    let passThrough = typeof options.passThroughFilter === "function" ? options.passThroughFilter : returnFalse;
...

  {
    ...
    MembraneInternal.prototype = Object.seal({
      ...
      buildMapping: function (handler, value, options = {}) {
        if (!this.ownsHandler(handler)) throw new Error("handler is not an ObjectGraphHandler we own!");
        ...
        assert(isOriginal || this.ownsHandler(options.originHandler), "Proxy requests must pass in an origin handler");
      ...
      ownsHandler: function (handler) {
        if (ChainHandlers.has(handler)) handler = handler.baseHandler;
        return handler instanceof ObjectGraphHandler && this.handlersByFieldName[handler.fieldName] === handler;
      },
      ...
      wrapArgumentByProxyMapping: function (mapping, arg, options = {}) {
        ...
        assert(argMap.getOriginal() === arg, "wrapArgumentByProxyMapping didn't establish the original?");
      },
      ...
      bindValuesByHandlers: function (handler0, value0, handler1, value1) {
        ...
        function bag(h, v) {
          ...
          if (rv.type !== "primitive") {
            ...
            const valid = !rv.proxyMap || (rv.proxyMap.hasField(field) && rv.proxyMap.getProxy(field) === v);
            if (!valid) throw new Error("Value argument does not belong to proposed ObjectGraphHandler");
          }
        ...
        function checkField(bag) {
          if (proxyMap.hasField(bag.handler.fieldName)) {
            ...
            if (check !== bag.value) throw new Error("Value argument does not belong to proposed object graph");
            bag.maySet = false;
      ...
      wrapDescriptor: function (originField, targetField, desc) {
        ...
        ["value", "get", "set"].forEach(function (descProp) {
          if (keys.includes(descProp))
            wrappedDesc[descProp] = this.convertArgumentToProxy(originHandler, targetHandler, desc[descProp]);
        }, this);
  ...
  function ObjectGraphHandler(membrane, fieldName) {
    ...
    Object.defineProperties(this, {
      ...
      passThroughFilter: {
        ...
        set: (val) => {
          if (passThroughFilter !== returnFalse) throw new Error("passThroughFilter has been defined once already!");
    ...
    Object.defineProperties(this, {
      ...
      proxiesInConstruction: new NWNCDataDescriptor(new WeakMap(/* original value: [callback() {}, ...]*/), false),
  ...
  }
  {
    ...
    ObjectGraphHandler.prototype = Object.seal({
      ...
      */
       ...
       */
        ...
        if (!found) {
          ...
          if (!isAccessorDescriptor(desc)) throw new Error("desc must be a data descriptor or an accessor descriptor!");
      ...
      // ProxyHandler
      getOwnPropertyDescriptor: inGraphHandler("getOwnPropertyDescriptor", function (shadowTarget, propName) {
        ...
        try {
          ...
          if (desc && !desc.configurable) {
            ...
            assert(!current || attempt, "Non-configurable descriptors must apply on the actual proxy target.");
          }
      ...
      */
       ...
       */
      defineProperty: inGraphHandler("defineProperty", function (shadowTarget, propName, desc, shouldBeLocal = false) {
        ...
        try {
          ...
          if (shouldBeLocal) {
            if (!Reflect.isExtensible(shadowTarget)) return Reflect.defineProperty(shadowTarget, propName, desc);
      ...
      */
        ...
        */
        ...
        if (!receiverMap) {
          ...
          if (receiverMap.originField === this.fieldName) throw new Error("Receiver's field name should not match!");
        }
      ...
      */
        ...
        if (!this.membrane.hasProxyForValue(this.fieldName, setter)) this.membrane.buildMapping(this, setter);
        ...
        if (!shouldBeLocal) {
          ...
          this.defineProperty(this.getShadowTarget(receiver), propName, new DataDescriptor(value), shouldBeLocal);
        }
      ...
      setPrototypeOf: inGraphHandler("setPrototypeOf", function (shadowTarget, proto) {
        ...
        try {
          ...
          if (rv)
            assert(Reflect.setPrototypeOf(shadowTarget, wrappedProxy), "shadowTarget could not receive prototype?");
      ...
      apply: inGraphHandler("apply", function (shadowTarget, thisArg, argumentsList) {
        ...
        if (mayLog) {
          this.membrane.logger.debug(
            ["apply originFields: inbound = ", argHandler.fieldName, ", outbound = ", this.fieldName].join("")
          );
        }
        ...
        if (targetMap.originField !== this.fieldName) rv = this.membrane.convertArgumentToProxy(argHandler, this, rv);
      ...
      construct: inGraphHandler("construct", function (shadowTarget, argumentsList, ctorTarget) {
        ...
        if (mayLog) {
          this.membrane.logger.debug(
            ["construct originFields: inbound = ", argHandler.fieldName, ", outbound = ", this.fieldName].join("")
          );
        }
      ...
      validateTrapAndShadowTarget: function (trapName, shadowTarget) {
        const target = getRealTarget(shadowTarget);
        const targetMap = this.membrane.map.get(target);
        if (!(targetMap instanceof ProxyMapping)) throw new Error("No ProxyMapping found for shadow target!");
      ...
      ensureMapping: function (target) {
        if (!this.membrane.hasProxyForValue(this.fieldName, target)) this.membrane.buildMapping(this, target);
      },
      ...
      lockShadowTarget: function (shadowTarget) {
        ...
        assert(Reflect.setPrototypeOf(shadowTarget, proto), "Failed to set unwrapped prototype on non-extensible?");
      ...
      defineLazyGetter: function (source, shadowTarget, propName) {
        ...
        function setLockedValue(value) {
          ...
          if (lockState !== "transient") throw new Error("setLockedValue should be callable exactly once!");
          lockedValue = value;
          lockState = "finalized";
        }
        ...
        const lazyDesc = {
          get: function () {
            ...
            if (lockState === "transient")
              return handler.membrane.getMembraneProxy(handler.fieldName, shadowTarget).proxy;
             ...
             */
            let current = Reflect.getOwnPropertyDescriptor(shadowTarget, propName);
            if (!current.configurable) throw new Error("lazy getter descriptor is not configurable -- this is fatal");
            ...
            if (sourceDesc !== undefined && targetMap.originField !== handler.fieldName) {
              ...
              sourceDesc = handler.membrane.wrapDescriptor(targetMap.originField, handler.fieldName, sourceDesc);
            ...
            assert(Reflect.deleteProperty(shadowTarget, propName), "Couldn't delete original descriptor?");
            assert(
          ...
          set: function (value) {
            ...
            assert(Reflect.deleteProperty(shadowTarget, propName), "Couldn't delete original descriptor?");
            assert(Reflect.defineProperty(this, propName, desc), "Couldn't redefine shadowTarget with descriptor?");
      ...
      getLocalFlag: function (target, flagName, recurse = false) {
        ...
        while (true) {
          let shouldBeLocal = map.getLocalFlag(field, flagName) || map.getLocalFlag(originField, flagName);
          if (shouldBeLocal) return true;
      ...
      revokeEverything: function () {
        ...
        for (var i = 0; i < length; i++) {
          ...
          if (revocable instanceof ProxyMapping) revocable.revoke(this.membrane);
  ...
  ModifyRulesAPI.prototype = Object.seal({
    ...
    createChainHandler: function (existingHandler) {
      ...
      let baseHandler = Reflect,
        description = "Reflect";
      if (ChainHandlers.has(existingHandler)) baseHandler = existingHandler.baseHandler;
  ...
  Object.defineProperties(DistortionsListener.prototype, {
    addListener: new NWNCDataDescriptor(function (value, category, config) {
      ...
      if (category === "prototype" || category === "value") this.valueAndProtoMap.set(value, config);
      else if (category === "iterable") Array.from(value).forEach((item) => this.valueAndProtoMap.set(item, config));
      else if (category === "instance") this.instanceMap.set(value, config);
      else if (category === "filter" && typeof value === "function") this.filterToConfigMap.set(value, config);
    ...
    removeListener: new NWNCDataDescriptor(function (value, category) {
      ...
      else if (category === "iterable") Array.from(value).forEach((item) => this.valueAndProtoMap.delete(item));
      else if (category === "instance") this.instanceMap.delete(value);
      else if (category === "filter" && typeof value === "function") this.filterToConfigMap.delete(value);
      else throw new Error(`Unsupported category ${category} for value`);
    }),
    ...
    bindToHandler: new NWNCDataDescriptor(function (handler) {
      ...
      if (handler.mayReplacePassThrough) handler.passThroughFilter = this.passThroughFilter.bind(this);
    }, true),
    ...
    applyConfiguration: new NWNCDataDescriptor(function (config, meta) {
      ...
      if (!meta.isOriginGraph && !Reflect.isExtensible(meta.target)) Reflect.preventExtensions(meta.proxy);
  ...
  */
  ...
  if (false) {
      ...
      (function buildMembrane(___utilities___) {
        ...
        const rvMembrane = new Membrane({
          ...
          passThroughFilter: (function () {
            ...
            items.splice(0, 0, Membrane, ObjectGraphHandler, DistortionsListener, ModifyRulesAPI);

            return function (value) {
              if (value === ProxyMapping || value === ProxyMapping.prototype || value instanceof ProxyMapping)
                throw new Error("ProxyMapping is private!");
              if (value === ProxyNotify) throw new Error("ProxyNotify is private!");
              return !items.some(function (item) {
                if (value === item || value === item.prototype || value instanceof item) return true;
...

        {
          ...
          ___listener___.addListener(ModifyRulesAPI, "value", {
            filterOwnKeys: ["arguments", "caller", "length", "name", "prototype"],
            proxyTraps: [
              "getPrototypeOf",
              "isExtensible",
              "getOwnPropertyDescriptor",
          ...
          ___listener___.addListener(Membrane, "value", {
            filterOwnKeys: ["arguments", "caller", "length", "name", "prototype", "Primordials"],
            proxyTraps: [
              "getPrototypeOf",
              "isExtensible",
              "getOwnPropertyDescriptor",
          ...
          ___listener___.addListener(Membrane, "instance", {
            filterOwnKeys: ["modifyRules", "passThroughFilter"],
            proxyTraps: [
              "getPrototypeOf",
              "isExtensible",
              "getOwnPropertyDescriptor",
          ...
          ___listener___.addListener(ObjectGraphHandler, "instance", {
            filterOwnKeys: ["fieldName", "passThroughFilter", "mayReplacePassThrough"],
            proxyTraps: [
              "getPrototypeOf",
              "isExtensible",
              "getOwnPropertyDescriptor",
    ...
    Reflect.defineProperty(MembraneInternal.prototype, "secured", new NWNCDataDescriptor(true, true));
    assert(MembraneInternal.prototype.secured, "Failed to set secured?");

    // Define our Membrane constructor properly.
    Membrane = DogfoodMembrane.convertArgumentToProxy(internalAPI, publicAPI, MembraneInternal);
    ...
    if (false) {
       ...
       * module, we're okay.
       */
      let finalWrap = DogfoodMembrane.convertArgumentToProxy(internalAPI, publicAPI, DogfoodMembrane);
