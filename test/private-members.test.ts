// The inspiration for these tests were the problems with proxies pointed out by Rob Eisenberg in this article: https://eisenbergeffect.medium.com/the-prickly-case-of-javascript-proxies-b6c3833b738
...
describe.each(membranes)("es-membrane tests --> %s membrane", (_, createMembrane: CreateMembraneFunction) => {
  describe("Membranes that proxy classes with private members", () => {
    ...
    it("does not throw with our membrane implementation", () => {
